...
if one_ahead:
    y_noisy_1 = base[:sample_cnt] + noise_intensity * noise_1
    y_noisy_2 = base[-sample_cnt:] + noise_intensity * noise_2
else:
    y_noisy_2 = base[:sample_cnt] + noise_intensity * noise_1
    y_noisy_1 = base[-sample_cnt:] + noise_intensity * noise_2
...
np.savetxt("./assets/txt/sig5.txt", signed_y1_16bit, fmt="%d")
np.savetxt("./assets/txt/sig6.txt", signed_y2_16bit, fmt="%d")
