...
#
# Script generated by Vivado on Fri May 10 20:54:02 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_i2s_0.sh
...
#
# Usage        : ila_i2s_0.sh
#                ila_i2s_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_i2s_0.sh [-reset_run]
#                ila_i2s_0.sh [-reset_log]
#                ila_i2s_0.sh [-help]
#
...
#                script (type 'ila_i2s_0.sh -help' for more information).
#
...
# script info
echo -e "ila_i2s_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_i2s_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../eko.srcs/ips/ila_i2s_0/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../eko.srcs/ips/ila_i2s_0/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../eko.srcs/ips/ila_i2s_0/hdl/verilog" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_i2s_0 xil_defaultlib.glbl -o ila_i2s_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_i2s_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_i2s_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_i2s_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_i2s_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_i2s_0.sh [-help]\n\
Usage: ila_i2s_0.sh [-step]\n\
Usage: ila_i2s_0.sh [-lib_map_path]\n\
Usage: ila_i2s_0.sh [-reset_run]\n\
Usage: ila_i2s_0.sh [-reset_log]\n\
Usage: ila_i2s_0.sh [-keep_index]\n\
Usage: ila_i2s_0.sh [-noclean_files]\n\n\
