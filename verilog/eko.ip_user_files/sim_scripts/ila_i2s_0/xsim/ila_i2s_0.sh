...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_15 -L smartconnect_v1_0 -L processing_system7_vip_v1_0_17 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_i2s_0 xil_defaultlib.ila_i2s_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_i2s_0 -key {Behavioral:testbench:Functional:ila_i2s_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_475c.protoinst" -protoinst "protoinst_files/eko_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_i2s_0.wdb xsim.dir libdpi.so)
